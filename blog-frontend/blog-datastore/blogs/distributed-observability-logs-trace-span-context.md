...
Logs
A log is a timestamped message emitted by services or other components. Logs aren’t enough for tracking code execution, as they usually lack contextual information, such as where they were called from.
